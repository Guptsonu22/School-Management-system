...
public class AMIT24 extends JFrame {
    ...
    public AMIT24() {
        ...
        try {
            BufferedImage image = ImageIO.read(new File("D:\\thirdyearproject\\AMIT24.jpg")); // Replace with your image path
        ...
        Object[][] data = {
            ...
            {"Class", "6th"},
            {"Roll Number", "11"},
            {"Father's Name", "Mr. Ankit Rathore"},
        ...
        attendanceButton.addActionListener(e -> {
            // Open the Attendance24 window
            Attendance24 attendancePage = new Attendance24();
        ...
        resultButton.addActionListener(e -> {
            // Open the Result24 window
            Result24 resultPage = new Result24();
